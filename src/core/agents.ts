...
export const researchAgents: ResearchAgent[] = [
  ...
  { model: 'gpt-4.1', maxToolCalls: 10, temperature: 0.6, lens: 'Search first for evidence that the claim is wrong: corrections, retractions, later revisions, and contradictory reporting. Conclude supported only if the counter-evidence search comes back empty.' },
